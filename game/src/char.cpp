...
void CHARACTER::PlayerPunish(bool PowerPunish, int Duration)
{
    ...
    {
        DBManager::instance().Query("UPDATE account.account SET availDt = FROM_UNIXTIME(UNIX_TIMESTAMP(CURRENT_TIMESTAMP()) + %i) WHERE id = %d", Duration, GetAID());
